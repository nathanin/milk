...
# "test"
# python batch_test.py --test $testtype --odir result_test --run_list runs_attention_mil.txt
# python batch_test.py --test $testtype --odir result_test --run_list runs_average_mil.txt
# python batch_test.py --test $testtype --odir result_test --run_list runs_instance_mil.txt
...
# "val"
# python batch_test.py --test $testtype --odir result_val --val --run_list runs_attention_mil.txt
# python batch_test.py --test $testtype --odir result_val --val --run_list runs_average_mil.txt
# python batch_test.py --test $testtype --odir result_val --val --run_list runs_instance_mil.txt
